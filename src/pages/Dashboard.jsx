            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <p className="text-slate-500 mt-2 mb-10 tracking-tight">
                    {searchTerm
                        ...
                        : <span>Selamat datang kembali, <b className="text-slate-800 font-bold">Fajar Farhan</b> 👋</span>}
                </p>
                    ...
                    {[
                        ...
                        <Card key={i}>
                            ...
                            >
                                ...
                                <h2 className="text-3xl font-black text-gray-800 mt-1">{stat.val}</h2>
                            </div>
                        </Card>
                    ))}
                </div>
                ...
                <Card>
                    ...
                    <Table headers={["ID Transaksi", "Customer", "Menu Utama", "Status", "Total Harga"]}>
                        {filteredOrders.length > 0 ? (
                            filteredOrders.map((o) => (
                                <tr key={o.id}>
                                    <td className="px-4 py-3 font-mono text-xs text-blue-600 font-bold">{o.id}</td>
                                    ...
                                    <td className="px-4 py-3 text-right font-bold text-gray-900">{o.price}</td>
                                </tr>
                            ))
                        ) : (
                            <tr>
                ...
                {selected && (
                    ...
                    >
                        <div className="text-center">
                            ...
                            <p className="text-gray-500 mb-8 leading-relaxed">Detail informasi untuk metrik <span className="font-bold text-gray-800">{selected}</span> akan segera hadir di modul Analisis Pro.</p>
                            <button
